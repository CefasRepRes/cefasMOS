# number of sigma points = num dimensions + 1
...
#' @details  It is possible to include control input in the GGfunction.
...
#' @param mod a list with the following components:
...
#' @param kappa a tuning parameter for the Sigma points.
